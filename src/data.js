export const insuranceDetails = [
    {
       ...
       "provider":{
          "en-ae":{
             ...
             "name":"Watania",
             "description":"National Takaful Company (Watania) is a young and dynamic organization that came into being in 2011. Wataniau2019s General Takaful department is responsible for all classes of insurance other than Motor and Medical. Resourced with highly experienced staff, this department is dedicated to serve mainly the commercial insurance needs of the market. The department has developed a wide a range of products to cater to the requirement of business of all sizes and types in all the major sectors of the market. All the products are Shariah compliant.",
             "time_to_policy":1,
